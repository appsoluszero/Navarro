...
public class Controller2D : RaycastController
{
    ...
    void DescendSlope(ref Vector3 velocity) {
        ...
        RaycastHit2D maxSlopeHitLeft = Physics2D.Raycast(raycastOriginPos.bottomLeft, Vector2.down, Mathf.Abs(velocity.y) + skinWidth, collisionMask);
        RaycastHit2D maxSlopeHitRight = Physics2D.Raycast(raycastOriginPos.bottomRight, Vector2.down, Mathf.Abs(velocity.y) + skinWidth, collisionMask);
